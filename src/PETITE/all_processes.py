...
# vegas_integrator_options = {
#     "PairProd": {"nitn": 10, "nstrat": [60, 50, 40, 50]},
...
vegas_integrator_options = {
    "PairProd": {"nitn": 10, "neval": n_points},
    "Brem": {"nitn": 10, "neval": n_points},
    "DarkBrem": {"nitn": 20, "neval": n_points},
    "Comp": {"nitn": 20, "neval": n_points},
    "Moller": {"nitn": 20, "neval": n_points},
    "Bhabha": {"nitn": 20, "neval": n_points},
    "Ann": {"nitn": 20, "neval": n_points},
    "DarkAnn": {"nitn": 10, "neval": n_points},
    "DarkComp": {"nitn": 20, "neval": n_points},
}
...
def integration_range(event_info, process):
    ...
    if process in four_dim:
        ...
        if "xmin" in event_info:  # DarkBrem
            ...
            xmin = 0.0
        return [
            [max(xmin, mV / EInc), 1.0 - m_electron / EInc],
            [-12.0, l1mct_max],
            [-20.0, 0.0],
        ]
...
def vegas_integration(event_info, process, verbose=False, mode="XSec"):
    ...
    # f_integrand = vg.lbatchintegrand(
    #     functools.partial(
    #         c_dsigma_brem_dimensionless,
    #         ep=event_info["E_inc"],
